...
export default {
    ...
    data () {
        return{
            drawer: true,
            links: [
                { icon: 'mdi-view-dashboard', text: 'Dashboard', route: '/staff'},
                { icon: 'mdi-folder', text: 'My Projects', route: '/staffprojects' },
                { icon: 'mdi-account', text: 'Staff', route: '/view/fellowstaff' },
            ],
            snackbar: true
        }
    }
